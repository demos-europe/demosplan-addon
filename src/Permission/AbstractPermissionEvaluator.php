 ...
 * {@link self::setAddonPermissions()} to make them available to the core.
 *
...
abstract class AbstractPermissionEvaluator implements PermissionEvaluatorInterface
{
    ...
    public function __construct(
        ...
        $this->setAddonPermissions($this->addonPermission);
     ...
     */
    abstract protected function setAddonPermissions(ResolvablePermissionCollectionInterface $permissionCollection): void;
}
