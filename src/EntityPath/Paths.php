...
class Paths
{
    ...
    public static function procedurePhase(): ProcedurePhasePath
    {
        return ProcedurePhasePath::startPath();
    }
    ...
    public static function accessControl(): AccessControlPath
    {
        return AccessControlPath::startPath();
    }
